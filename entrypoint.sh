#!/bin/sh
# Forked from https://github.com/edoburu/docker-pgbouncer (MIT) with Railway
# defaults:
#   - listen_addr defaults to * so pgbouncer accepts IPv6 private-network
...
# Default before any use: the userlist generator branches on AUTH_TYPE to
# decide between storing an md5 hash and the plaintext needed for SCRAM.
